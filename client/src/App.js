  ...
  render () {
    return(
      <div className="App">
        ...
        <Route exact path="/profile/:id" render={(props) => <Profile {...props} userInSession={this.state.loggedInUser} updateUser={this.updateLoggedInUser}/>} />
        <Route exact path="/etiquette/ajout"  render ={() => <AddEtiquette updateUser= {this.updateLoggedInUser} userInSession={this.state.loggedInUser}/>}/>
